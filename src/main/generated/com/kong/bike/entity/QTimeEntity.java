...
public class QTimeEntity extends EntityPathBase<TimeEntity> {
    ...
    private static final long serialVersionUID = -1756856494L;

    public static final QTimeEntity timeEntity = new QTimeEntity("timeEntity");

    public final DateTimePath<java.time.LocalDateTime> createdDate = createDateTime("createdDate", java.time.LocalDateTime.class);

    public final StringPath formattedCreatedDate = createString("formattedCreatedDate");

    public final StringPath formattedModifiedDate = createString("formattedModifiedDate");
